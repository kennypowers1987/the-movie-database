...
var Gather = {
  ...
  addToDb: function (time, callback) {
    ...
    return db.query("INSERT INTO movies (id, adult, backdrop_path, original_language, original_title, overview, popularity, poster_path, release_date, title, video, vote_average, vote_count ) values ?", [flattenedData], function (err, result) {
      if (err) {
        throw err;
      }
      else {
